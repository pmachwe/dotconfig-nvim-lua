...
vim.api.nvim_set_keymap("n", "<leader>/",  ":Telescope grep_string search=<C-R><C-W> cwd=%:p:h<cr>", {noremap = true, silent = true, desc = "Grep current word (cwd)"})
vim.api.nvim_set_keymap("n", "<leader>?",  ":Telescope grep_string search=<C-R><C-W><cr>", {noremap = true, silent = true, desc = "Grep current word (root dir)"})
